    ...
    <div class="container mx-auto mt-6">
        ...
        <nav class="mb-4 mx-5" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <li>
                    <span class="text-gray-800 dark:text-gray-200 font-semibold">Warehouse</span>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg overflow-hidden mx-5">
            ...
            <div class="flex justify-between items-center mb-6 mx-8 my-2">
                <h1 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mx-2">Mengelola Gudang</h1>
                <a href="{{ route('Warehouse.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg inline-block transition duration-200 ease-in-out flex items-center">
            ...
            <div class="overflow-x-auto mx-2">
                <table id="warehouse-table" class="min-w-full bg-white dark:bg-gray-800 table-auto">
                    <thead class="bg-gray-100 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-sm font-medium text-gray-600 dark:text-gray-200">Kode Gudang</th>
                            <th class="px-6 py-4 text-left text-sm font-medium text-gray-600 dark:text-gray-200">Nama Gudang</th>
                            <th class="px-6 py-4 text-left text-sm font-medium text-gray-600 dark:text-gray-200">Jenis Gudang</th>
                            ...
                            <th class="px-6 py-4 text-left text-sm font-medium text-gray-600 dark:text-gray-200">Keterangan</th> <!-- New column -->
