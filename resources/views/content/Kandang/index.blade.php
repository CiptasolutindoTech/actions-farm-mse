    ...
    <div class="container mx-auto mt-6">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg overflow-hidden mx-5">
            ...
            <div class="flex justify-between items-center mb-6 mx-8 my-2">
                <h1 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mx-2">Kandang</h1>
                <a href="{{ route('kandang.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg inline-block transition duration-200 ease-in-out flex items-center">
                    <i class="fas fa-plus mr-2"></i> {{ __('Tambah Kandang') }}
                </a>
            </div>
                        ...
                        @foreach($kandang as $cage)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 text-sm flex space-x-2">
                                    <a href="{{ route('kandang.edit', $cage->cage_id) }}"
                                    ...
                                    <form action="{{ route('kandang.destroy', $cage->cage_id) }}" method="POST" class="delete-form inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button"
